...
from ..components import player,brick,stuff,box,enemy,coin,pipe_and_well,bag,powerup
import os
import json
...
class Level2:
    ...
    def start(self,game_info):
        ...
        self.bag=bag.Bag('level2',self.game_info)
    ...
    def setup_background(self):
        ...
        self.background = setup.GRAPHICS['level_2.png']
    ...
    def update_game_window(self):
        ...
        if self.player.rect.centerx > 500 and self.player.rect.centerx < 4200:
    ...
    def draw(self, surface):
        ...
        if self.player.rect.x > 4600 and self.game_info['num'] >= 15:
