...
class Chengyu:
    ...
    def start(self, game_info):
        ...
        self.explanation2 = [setup.GRAPHICS['question2_1.png'], setup.GRAPHICS['question2_2.png'],
                             setup.GRAPHICS['question2_3.png'], setup.GRAPHICS['question2_4.png']]
        self.explanation3 = [setup.GRAPHICS['question3_1.png'], setup.GRAPHICS['question3_2.png']]

        self.frames_answer = [pygame.image.load(os.path.abspath("resource/graphics/answer1.png")),
                              pygame.image.load(os.path.abspath("resource/graphics/answer2.png")),
                              pygame.image.load(os.path.abspath("resource/graphics/answer3.png"))]
    ...
    def update(self, surface, flag):  # 更新操作
        ...
        if mouse == (1, 0, 0) and self.i < len(
                self.frames_explanation[self.num]) and check_right != 8 and self.ct != 0 and self.before_i < self.i:
